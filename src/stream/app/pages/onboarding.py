...
def onboarding_page():
    return Page(
        ...
        DiagnosticFrame(
            "ONBOARDING RISK",
            P(
                "When new customers sign up at a regulated exchange, they go through KYC (Know Your Customer) verification. "
        ...
        DiagnosticFrame(
            ...
            P(
                "Interactive demo: fill out a mock signup form and get a risk score with explanation.",
        ...
        DiagnosticFrame(
            ...
            Div(
                ...
                **{
                    "hx-get": "/api/v1/onboarding/metrics",
                    "hx-trigger": "load",
                    "hx-swap": "innerHTML",
                },
            ),
