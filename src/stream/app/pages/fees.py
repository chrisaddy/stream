...
def fees_page():
    return Page(
        ...
        DiagnosticFrame(
            "FEE ESTIMATION",
            P(
                "Bitcoin transactions compete for limited block space by offering fees. "
        ...
        DiagnosticFrame(
            ...
            Div(
                id="mempool-state",
                **{
                    "hx-get": "/api/v1/fees/mempool-state",
                    "hx-trigger": "load, every 30s",
                    "hx-swap": "innerHTML",
                },
