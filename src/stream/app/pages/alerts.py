...
def alerts_page():
    return Page(
        ...
        DiagnosticFrame(
            "ALERT QUEUE",
            P(
                "Transactions scored above the risk threshold are automatically queued here for compliance review. "
        ...
        DiagnosticFrame(
            ...
            Div(
                P(
                    "Select an alert from the queue to view ",
                    Tip("SHAP"),
                    " explanation and ",
                    Tip(
                        "LLM",
                        "Large Language Model — AI that generates human-readable text. Used here to convert technical SHAP values into compliance narratives.",
                    ),
