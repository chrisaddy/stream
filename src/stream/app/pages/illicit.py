...
def illicit_page():
    return Page(
        ...
        DiagnosticFrame(
            "ILLICIT DETECTION",
            P(
                "Regulated Bitcoin exchanges must screen every transaction for potential illicit activity "
        ...
        DiagnosticFrame(
            ...
            H3(
                ...
                style="color: var(--fg-green); font-size: 13px; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 16px;",
            ),
            Div(
                Table(
                    Thead(
        ...
        DiagnosticFrame(
            "INTERACTIVE SCORING",
            P(
                "Submit transaction features for real-time risk scoring with ",
                Tip("SHAP"),
                " explanation.",
            ...
            Form(
                Div(
                    Label(
                        "Feature Vector (comma-separated, 166 values)",
                        style="font-size: 10px; color: var(--fg-dim); text-transform: uppercase; letter-spacing: 1px;",
                    ),
                    Textarea(
                ...
                Div(
                    ...
                    Button(
                        ...
                        **{
                            "hx-get": "/api/v1/illicit/random-sample",
                            "hx-target": "#feature-input",
                            "hx-swap": "innerHTML",
                        },
                    ),
        ...
        DiagnosticFrame(
            ...
            Div(
                Label(
                    ...
                    style="font-size: 10px; color: var(--fg-dim); text-transform: uppercase;",
                ),
                Input(
                    type="range",
                    min="0.1",
                    ...
                    id="threshold-slider",
                    **{
                        "hx-get": "/api/v1/illicit/threshold-analysis",
                        "hx-trigger": "change",
                        "hx-target": "#threshold-result",
                ...
                Div(
                    ...
                    style="color: var(--fg-green); font-size: 16px; margin-top: 8px;",
                ),
            ),
