...
def walkthrough_overview():
    return Page(
        ...
        DiagnosticFrame(
            ...
            P(
                "4-minute walkthrough: live scoring, instant learning, drift detection, "
    ...
    -> SHAP explanation + Claude narrative
      -> Analyst review (TP / FP / escalate)
        ...
        DiagnosticFrame(
            "DEEP DIVES",
            P(
                "Each section explains one part of the system in detail — the problem, the approach, and the design decisions.",
